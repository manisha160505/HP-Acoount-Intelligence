...
def strategy_chat_ask(
    ...
    # confident strategy advice in answer to a pitch, with no signal that the
    ...
    if body.persona_id and not strategy_personas.resolve(account_id,
        ...
        # this account's people. The same isolation the evidence ids have.
        raise HTTPException(
            status_code=status.HTTP_404_NOT_FOUND,
