...
| Where it came from | Google Drive folder 1eZvNHHKo_WZyoYWJbPB_FHZl04vLiw25 (18 Sep 2026); seed from Konika's 31 Aug mail. Local: `220 account data /explorium_clean_220(.zip)`; seed `docs/Source A.xlsx`. |
