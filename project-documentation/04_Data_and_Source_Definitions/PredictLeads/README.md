...
| Where it came from | Google Drive folder 1eZvNHHKo_WZyoYWJbPB_FHZl04vLiw25, hiring data added 18 Sep 13:32 UTC. Local: `220 account data /predictleads_combined_219_accounts.xlsx`. Seed: `docs/job_openings.csv` (Astra, from the 31 Aug "Source B.xlsx" not on this machine). |
