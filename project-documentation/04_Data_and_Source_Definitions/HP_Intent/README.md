...
| Where it came from | SharePoint (3 Sep, Astra); Drive folder 1eZvNHHKo… (18 Sep, 220 accounts). NSW Education intent added to Drive 23 Sep (**not on this machine**). |
...
| Known gaps | 47 accounts without scores; NSW Education file missing locally. |
