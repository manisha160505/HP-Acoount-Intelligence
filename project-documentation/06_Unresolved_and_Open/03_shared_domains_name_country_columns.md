# Shared domains jabil.com and mufg.jp: which entity owns the rows

**Issue ids:** D3 · **Status:** PARTIALLY RESOLVED · **Affects:** Hiring, tech detections, news, connections for 4 accounts

## Issue
Shared domains jabil.com and mufg.jp: which entity owns the rows.

## What we asked
- (D3) Data question 2 (23 Sep) and item 3. Can vendors supply a per-entity id? Treat the pairs as one account? Which entity owns the rows?
