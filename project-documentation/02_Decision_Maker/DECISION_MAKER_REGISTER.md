...
| 14 | PredictLeads_219_Account_Domain_Audit.xlsx | same | Client email, Dhruvi, 25 Sep 2026 (C43) | 25 Sep | 1 | Supersedes the interim domain rule | **NOT ON THIS MACHINE** — placeholder here | **CLIENT — FINAL** (use only sheet 219_Account_Domain_Audit) | Canonical domain + display name for every account |
| 15 | clarifying_opens_3_OPEN_v2.docx (client-annotated) | same | Client email, Dhruvi, 25 Sep 2026 (C44) | 25 Sep | annotated | No | **NOT ON THIS MACHINE** — placeholder here | **CLIENT — ANSWERS** to the 25 open round-3 items | Every open item in 05/Open |
