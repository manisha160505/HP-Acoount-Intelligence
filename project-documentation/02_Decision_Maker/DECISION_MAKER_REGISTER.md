...
| 13 | 2026-09-25_Dhruvi_email_relevance_directions_and_domain_audit.md | (email body, verbatim) | Client email, Dhruvi, 25 Sep 2026 05:50 + 06:24 UTC (C45) | 25 Sep | verbatim | No | This one | **CLIENT — FINAL** | Relevance direction (DEC-053); domain audit usage rules (DEC-052) |
| 14 | PredictLeads_219_Account_Domain_Audit.xlsx | same | Client email, Dhruvi, 25 Sep 2026 (C43) | 25 Sep | 1 | Supersedes the interim domain rule (DEC-013) | This one | **CLIENT — FINAL** (use only sheet "219 Account Audit"; Master Domain = canonical; Column H notes; Column B = display name; 219 rows, Astra absent) | Canonical domain + display name for every account |
| 15 | clarifying_opens_3_OPEN_v2_provided.docx | clarifying_opens_3_OPEN_v2.docx (client-annotated) | Client email, Dhruvi, 25 Sep 2026 (C44) | 25 Sep | annotated | No | This one | **CLIENT — ANSWERS** to the 25 open round-3 items (ingested 25 Sep) | News precedence, empty state, labels, as-of date, proof placement, filings re-keying, contacts (one file) |
