...
add(id='C43', name='PredictLeads_219_Account_Domain_Audit.xlsx', src=OUT/'04_Data_and_Source_Definitions/Account_List/PredictLeads_219_Account_Domain_Audit.xlsx', dest='04_Data_and_Source_Definitions/Account_List', origin='CLIENT DATA', sender='Dhruvi Patel (BridgeAI)',
    ...
    status='CURRENT', supersedes='DEC-013 interim rule (PredictLeads domain canonical + 4 overrides) and the split\'s derived domains',
    ...
    notes='Downloaded by the user 25 Sep 12:30 IST. Actual sheet name is "219 Account Audit" (email said 219_Account_Domain_Audit); 219 rows - Astra absent (seed delivery); Column H "considerations to keep in mind": OK ×204, "consider both names same" ×13, blank ×2 (Stanley, Shiseido). Domains differ from the 25 Sep split for Posco, Pilipinas Shell and Public Bank.', also=['02_Decision_Maker'])
add(id='C44', name='clarifying_opens_3_OPEN_v2_provided.docx (client-annotated OPEN_v2)', src=OUT/'01_Client_Provided/Client_Answers/clarifying_opens_3_OPEN_v2_provided.docx', dest='01_Client_Provided/Client_Answers', origin='CLIENT', sender='Dhruvi Patel (BridgeAI)',
    ...
    status='CURRENT', used_for='Client answers (highlighted) to the 25 open items A1, A3, B2-B4, C4, C5, D1, D2, E1, F7, G1-G3, H1, I1, I2, F1a-c, F8-F13. CLARIFICATIONS and UNRESOLVED_v2 were not answered in this message.',
    notes='Saved by the user as clarifying_opens_3_OPEN_v2_provided.docx (25 Sep 12:30 IST); original attachment name clarifying_opens_3_OPEN_v2.docx. Answers ingested into the question register and DECISION_LOG on 25 Sep.', also=['02_Decision_Maker','05_Questions_and_Clarifications/Source_Documents'])
...
add(id='C39c', name='apollo_data.xlsx (3 Sep)', src=ROOT/'docs/apollo_data.pdf', dest='04_Data_and_Source_Definitions/Contacts_Apollo', origin='CLIENT DATA', sender='Konika Thakur (BridgeAI)', channel=SP,
    date='2026-09-03', status='REFERENCE (Astra seed only)', used_for='Contacts + phone numbers for the Astra seed account. Only a PDF print exists locally; the xlsx is on SharePoint. The 220-account contact file arrived 26 Sep (C49).',
...
add(id='C22b', name='predictleads_combined_219_accounts.xlsx', src=ROOT/'220 account data /_superseded_2026-09-25/predictleads_combined_219_accounts.xlsx', dest='04_Data_and_Source_Definitions/PredictLeads/_SUPERSEDED', origin='CLIENT DATA', sender='Dhruvi Patel (BridgeAI)',
    channel=DRIVE_DATA+' - hiring data added 18 Sep 13:32 UTC', date='2026-09-18', status='SUPERSEDED', superseded_by='C48 predictleads_combined_219_accounts_company_country.xlsm (25 Sep)', used_for='company, extended_company, job_openings, technology_detections, news_events, financing_events, connections, subpages, products, similar_companies, sec_filings + QA sheets. Client 23 Sep: use sec_filings and products; ignore the rest of the new sheets.')
add(id='C22c', name='exa_data.xlsx', src=ROOT/'220 account data /_superseded_2026-09-25/exa_data.xlsx', dest='04_Data_and_Source_Definitions/Exa/_SUPERSEDED', origin='CLIENT DATA', sender='Dhruvi Patel (BridgeAI)', channel=DRIVE_DATA, date='2026-09-18',
    status='SUPERSEDED', superseded_by='C46 exa_data (3)_2025-2026.xlsx (25 Sep)', used_for='Exa.ai news feed (9,221 rows, 14 cols, same schema as Google News RSS). Merged with RSS for Live Signals.')
add(id='C22d', name='google_news_rss_data 1.xlsx', src=ROOT/'220 account data /_superseded_2026-09-25/google_news_rss_data 1.xlsx', dest='04_Data_and_Source_Definitions/Google_News_RSS/_SUPERSEDED', origin='CLIENT DATA', sender='Dhruvi Patel (BridgeAI)', channel=DRIVE_DATA, date='2026-09-18',
    status='SUPERSEDED', supersedes='google_news_rss_data.xlsx (31 Aug, Astra only - not on this machine)', superseded_by='C47 google_news_rss_data 2 (2)_2025-2026.xlsx (25 Sep)', used_for='Google News RSS feed (7,913 rows). Merged with Exa for Live Signals.')
# 25 Sep 2026 12:34 UTC re-drop into the same Drive folder. Dhruvi: "Please consider the following
# files as the latest versions for the build" and "use only this file going forward".
DRIVE_DATA_25 = 'Google Drive folder 1eZvNHHKo_WZyoYWJbPB_FHZl04vLiw25 (Dhruvi, 25 Sep 2026 12:34 UTC, ' + MAIN + ')'
add(id='C46', name='exa_data (3)_2025-2026.xlsx', src=ROOT/'220 account data /exa_data (3)_2025-2026.xlsx', dest='04_Data_and_Source_Definitions/Exa', origin='CLIENT DATA', sender='Dhruvi Patel (BridgeAI)', channel=DRIVE_DATA_25, date='2026-09-25',
    status='CURRENT', supersedes='C22c exa_data.xlsx (18 Sep)', used_for='Exa.ai news feed, event_date re-crawled: 3,726 rows, all dated, 215 accounts, 2025-01-01 to 2026-10-19. Merged with RSS for Live Signals. Client: last 12 months only.',
...
add(id='C47', name='google_news_rss_data 2 (2)_2025-2026.xlsx', src=ROOT/'220 account data /google_news_rss_data 2 (2)_2025-2026.xlsx', dest='04_Data_and_Source_Definitions/Google_News_RSS', origin='CLIENT DATA', sender='Dhruvi Patel (BridgeAI)', channel=DRIVE_DATA_25, date='2026-09-25',
    status='CURRENT', supersedes='C22d google_news_rss_data 1.xlsx (18 Sep)', used_for='Google News RSS feed, event_date populated: 4,159 rows, all dated, 94 accounts, 2025-01-01 to 2026-09-17. Merged with Exa for Live Signals. Client: last 12 months only.',
...
add(id='C48', name='predictleads_combined_219_accounts_company_country.xlsm', src=ROOT/'220 account data /predictleads_combined_219_accounts_company_country.xlsm', dest='04_Data_and_Source_Definitions/PredictLeads', origin='CLIENT DATA', sender='Dhruvi Patel (BridgeAI)', channel=DRIVE_DATA_25, date='2026-09-25',
    status='CURRENT', supersedes='C22b predictleads_combined_219_accounts.xlsx (18 Sep)', used_for='Same 19 sheets and row counts as C22b, with company_name and account_country_code added to every sheet (D3). Client: the job openings here are the final hiring dataset for now; vendors are being asked for the remaining 43 accounts.',
...
DRIVE_DATA_26 = 'Google Drive folder 1eZvNHHKo_WZyoYWJbPB_FHZl04vLiw25 (Dhruvi, announced 26 Sep 2026 03:26 UTC, ' + MAIN + ')'
add(id='C49', name='Apollo_All_Contacts (1).xlsx', src=ROOT/'220 account data /Apollo_All_Contacts (1).xlsx', dest='04_Data_and_Source_Definitions/Contacts_Apollo', origin='CLIENT DATA', sender='Dhruvi Patel (BridgeAI)', channel=DRIVE_DATA_26, date='2026-09-26',
    status='CURRENT', supersedes='C39c apollo_data.xlsx (Astra seed, 3 Sep) as the contact source for the 220', used_for='The one contact file for all 220 accounts (D8). Sheets: Contacts (2,296 rows, header on row 5), Pending and review (5), Companies (220, coverage per company). 192 accounts have contacts, 28 none. Feeds prospect_contacts: Stakeholder Map, Opportunity Map, Objection Playbook, Content Studio, Message Evaluator.',
...
add(id='C50', name='filings_client_supplement_2026-09-26.csv', src=OUT/'04_Data_and_Source_Definitions/Filings/filings_client_supplement_2026-09-26.csv', dest='04_Data_and_Source_Definitions/Filings', origin='CLIENT DATA (URLs) transcribed by delivery team', sender='Dhruvi Patel (BridgeAI)', channel=MAIN+', 26 Sep 2026 03:26 UTC (URLs in the email body)', date='2026-09-26',
    status='CURRENT', used_for='Six filing documents the crawl missed: ANZ Holdings NZ (3 disclosure statements), CIMB Group Holdings (integrated annual report + financial statements 2025), CIMB Niaga (annual report 2025). Same columns as filings 1.csv, row_id S26-1..6; read after it by split_account_data.py and fetch_filings.py.',
...
add(id='C33', name='NSW_Education_Public_Intent.xlsx', src=ROOT/'220 account data /NSW_Education_Public_Intent.xlsx', dest='04_Data_and_Source_Definitions/HP_Intent', origin='CLIENT DATA', sender='Dhruvi Patel (BridgeAI)', channel=DRIVE_DATA+' - added 23 Sep 2026 05:53 UTC', date='2026-09-23',
    status='CURRENT', used_for='Intent data for DEPARTMENT OF EDUCATION - NSW, AU (education.nsw.gov.au), missing from the 18 Sep intent file. Same 55-column wide layout as hp_intent_results 2.xlsx; one row (PCs 80/100, top category). The split replaces that domain\'s "Unavailable" row with it.',
