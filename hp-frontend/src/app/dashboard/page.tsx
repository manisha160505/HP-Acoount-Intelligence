...
export default function UserDashboardPage() {
  ...
  // read from a widget: `extract_strategy_chat` does not declare
  // `prospect_contacts` as a dependency, so a widget copy would go stale at
  // exactly the moment a new roster was uploaded. An empty list is a valid
  // answer - an account with no contacts gets no personas, never a default set.
  useEffect(() => {
                  ...
                  const handleSendPrompt = async (promptText: string) => {
                    ...
                    const publish = (
                      ...
                      setChatMessages(prev => [...prev, {
                        ...
                        personaTitle: available ? personaTitle : undefined,
                      }]);
                    };
                        ...
                        <div className="flex items-center gap-2">
                          ...
                          <select
                            ...
                            onChange={(e) => {
                              ...
                              // "and what about the cost?" would be resolved
                              // against a different role's answer.
                            ...
                            className="px-3 py-2 bg-slate-50 border border-slate-300 rounded-xl text-xs font-extrabold text-slate-800 shadow-xs focus:outline-none focus:ring-2 focus:ring-hp-blue/30 disabled:opacity-60"
                          >
                            ...
                            <div className="text-center max-w-2xl mx-auto space-y-3">
                              ...
                              {activePersona ? (
                                /* The disclaimer is the Objection Playbook's,
                                   ...
                                   record it was built from keeps provenance
